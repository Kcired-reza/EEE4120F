...
#-------------------------Retrieve Image Data:---------------------------
imgO = load("ASHLAND.bmp")

imgG = rawview(channelview(Gray.(imgO)))
save("ASHLAND_gray", imgG)
...
#-----------------------Save Encoded Image:----------------------------
save("ASHLAND_encoded.bmp", imgG)

Out1 = load("ASHLAND_encoded.bmp")
Out2 = rawview(channelview(Gray.(Out1)))

io = open(raw"C:\Users\kaibr\Desktop\My Files\UCT Work\EEE4120F\_Group Repo\EEE4120F\YODA Project\Julia\ASHLAND_raw.txt", "w")
println(io, "===============     JPEG DATA      =======================")
println(io, Out1)
close(io)

io2 = open(raw"C:\Users\kaibr\Desktop\My Files\UCT Work\EEE4120F\_Group Repo\EEE4120F\YODA Project\Julia\ASHLAND_channelview.txt", "w")
