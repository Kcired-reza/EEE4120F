...
#
# Generated by export_simulation on Fri Jun 26 17:17:36 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './bram_encoded_message.sh' script.

./bram_encoded_message.sh -reset_run
...
./bram_encoded_message.sh -noclean_files

For more information on the script, please type './bram_encoded_message.sh -help'.
