...
#
# Generated by export_simulation on Fri Jun 26 22:19:58 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './bram_decoded_message.sh' script.

./bram_decoded_message.sh -reset_run
...
./bram_decoded_message.sh -noclean_files

For more information on the script, please type './bram_decoded_message.sh -help'.
